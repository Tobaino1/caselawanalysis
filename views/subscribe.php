...
<html lang="en">
<head>
    <title>Case law analysis system ! subscribe</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Subscription page</h1>
<!--                <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact Us <i class="ion-ios-arrow-forward"></i></span></p>-->
                <form enctype="multipart/form-data" action="../model/subscription_con.php" name="form" method="post">


                    <input type="text" id="surname" name="surname"  size="60" required placeholder="Surname">
                    <br><br>
                    <input type="text" id="othernames" name="othernames"  size="60" required placeholder="Othernames">
                    <br><br>
                    <input type="text" name="email" id="email"  placeholder="Email"  size="60" required>
                    <br><br>
                    <input type="text" id="phone" name="phone" size="60" maxlength="11" minlength="11" required placeholder="Phone">
                    <br><br>
                    <input type="password" id="password" name="password"  required size="60" placeholder="Password">
                    <br><br>
                    <input type="text" name="nba_no" id="nba_no"  placeholder="NBA No"  size="60" required>
                    <br><br>
                    <input type="text" id="chamber" name="chamber"  required size="60" placeholder="Chamber">
                    <br><br>
                    upload image
                    <input type="file" id="image" name="image" size="70" required>
                    <br><br>
