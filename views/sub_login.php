...
<html lang="en">
<head>
    <title>Case Law Analysis | subscriber's Login </title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Subscriber's Login Page</h1>
                ...
                <form enctype="multipart/form-data" action="../model/sub_con.php" name="form" method="post">


                    <input type="text" name="nba_no" required="required" placeholder="NBA No" size="50" required>
                    <br><br>
