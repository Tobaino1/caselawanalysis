...
<html lang="en">
<head>
    <title>Case Law Analysis | ADMIN Login </title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Admin Login Page</h1>
                ...
                <form enctype="multipart/form-data" action="./admin.php" name="form" method="post">
