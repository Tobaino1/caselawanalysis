...
<html lang="en">
  <head>
    <title>Case law analysis system ! contact us</title>
    <meta charset="utf-8">
    ...
    <section class="ftco-section contact-section">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Lagos State University, Lagos , Nigeria</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://08126251073">+ 234 8126 251 073</a></p>
          </div>
          <div class="col-md-3">
            <!--<p><span>Email:</span> <a href="mailto:tobainocycle@gmail.com">case law analysis system admin</a></p>-->
          </div>
          <div class="col-md-3">
            <!--<p><span>Website</span> <a href="#">clas.com</a></p>-->
          </div>
        </div>
        <div class="row block-9"> <h4 align="center">CONTACT / FEEDBACK FORM</h4>
...
<!--              </div>-->
              ...
              <div class="form-group">
                <textarea name="" id="" cols="30" rows="7"  name="msg" id="msg" class="form-control" placeholder="Message" required></textarea>
              </div>
              <div class="form-group">
                <input type="submit" value="Send Message"  name="submit" id="submit" class="btn btn-primary py-3 px-5">
                  <input type="reset" value="Reset / Clear"  name="reset" id="reset" class="btn btn-primary py-3 px-5">
