...
<section class="ftco-section contact-section">
    <div class="container">
        ...
        <div class="row block-9"> <h4 align="center">
                <a href="./courts.php"> Get Law reports </a>
                <br>
                <a href="./courts.php"> Get previous Courts verdicts </a>
<br>
                <a href="./courts.php"> Get Legal advise / work with expert lawyers </a>
<br>
                <a href="./rules_logic.php"> Get a Case preview / predict the likely outcome for fresh cases </a>
