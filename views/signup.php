...
<html lang="en">
<head>
    <title>Case Law Analysis | Sign up</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Sign Up Page</h1>
<!--                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Attorneys <i class="ion-ios-arrow-forward"></i></span></p>-->
                ...
                <form enctype="multipart/form-data" action="../model/register_con.php" name="form" method="post">
                    ...
                    <br><br>
                    <input type="text" id="username" name="username"  required size="60" placeholder="username">
                    <br><br>
                    <input type="password" id="password" name="password"  required size="60"
                    ...
                    <br><br>
                    <input type="text" name="occupation" id="occupation"  placeholder="Occupation"  size="60" required>
<br><br>
                    upload image
